...
/*
Auto-generated by: https://github.com/pmndrs/gltfjsx
Author: GabrielHenriqueRosa (https://sketchfab.com/gabrielhenriquehero)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/spiderwick-sprite-flower-head-animation-8a7c735bf87b4cd0b0197925b7cb249b
Title: Spiderwick| Sprite- Flower- Head |Animation|
*/
"use client"
import React, { useRef } from 'react'
...
export default function FairyModel(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/fairy-transformed.glb')
  ...
  useFrame((state, delta, xrFrame) => {
        modelRef.current.position.y =
          -3.2 + Math.sin(state.clock.elapsedTime) * 0.15;
      });
    ...
    >
      <group name="Sketchfab_Scene">
        ...
        <skinnedMesh
          ...
          material={materials.sprite}
          skeleton={nodes.Object_7.skeleton}
          position={[0.446, 12.513, 1.178]}
        />
      </group>
    </group>
  )
...
useGLTF.preload('/models/fairy-transformed.glb')